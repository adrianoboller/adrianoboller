...
class Phxsqld:
    ...
    def __init__(self):
        ...
        cfg = {
            "base": "dados",
            # bancada de teste, NAO cliente do produto -- fala em claro para medir "A prova do DbLink contra um PostgreSQL(R) DE VERDADE" sem o aperto de mao no meio (servidor exige a cifra por padrao desde o pedido 370)

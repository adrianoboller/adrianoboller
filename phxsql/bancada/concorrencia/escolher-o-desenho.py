...
class Servidor:
    ...
    def __init__(self, porta, durabilidade="por_lote"):
        ...
        cfg = {
            "base": "dados",
            # bancada de teste, NAO cliente do produto -- fala em claro para medir "Trava por tabela, 'RwLock' ou MVCC: a medicao que ESCOLHE entre os tres" sem o aperto de mao no meio (servidor exige a cifra por padrao desde o pedido 370)

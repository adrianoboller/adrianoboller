...
class Servidor:
    ...
    def __enter__(self):
        ...
        with open(cfg, "w") as f:
            json.dump(
                {
                    # bancada de teste, NAO cliente do produto -- fala em claro para medir "Sonda da PARTICAO POR QUANTIDADE contra o motor vivo" sem o aperto de mao no meio (servidor exige a cifra por padrao desde o pedido 370)

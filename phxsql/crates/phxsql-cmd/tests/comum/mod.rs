//! Apoio aos testes de INTEGRACAO do `phxsql-cmd` (cada arquivo de
...
//!
//! O prefixo `phxcmd-it-` e proprio deste crate: com um prefixo por familia,
...
impl DirTemp {
    ...
    pub fn novo(rotulo: &str) -> DirTemp {
        ...
        p.push(format!("phxcmd-it-{}-{rotulo}-{n}", std::process::id()));

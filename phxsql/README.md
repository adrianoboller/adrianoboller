...
O motor de armazenamento está completo e testado: **1.775 testes** no projeto inteiro, com **130 operações** no protocolo e **0 dependências externas** (só a `std`) — o que faz o projeto compilar offline.
<!-- readme:testes:fim -->

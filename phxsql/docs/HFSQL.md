...
| Ferramenta de administração gráfica | Centro de Controle na web, sem instalar nada; todas as operações do catálogo (`crates/phxsql-server/src/catalogo.rs`) no protocolo | a deles é executável Windows |

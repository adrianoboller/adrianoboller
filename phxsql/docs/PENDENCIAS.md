...
**156 pedidos: 154 feitos · 2 parciais · 0 planejados.**
...
- ***ACID compliant* continua falso — e mudou de motivo.** O **A** e o **I**
  ...
  agora é o **C**. A integridade referencial **não é imposta**: a chave
  estrangeira é catálogo, e há teste travando isso pelo nome
  (`a_chave_e_declarada_mas_ainda_nao_e_imposta_na_gravacao`). Enquanto uma
  linha filha apontando para um pai que não existe entrar sem reclamação, o
  **C** não está inteiro.

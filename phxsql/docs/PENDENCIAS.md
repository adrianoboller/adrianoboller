...
| ◐ | 111 | **A réplica acompanhar a escrita do master** | não acompanha: 4.357 eventos/s contra 28.914 linhas/s. Aplicar decodifica a imagem para `Value` e **reencoda** o payload, em vez de gravar os bytes que vieram. Gravar direto, remendando só os ponteiros dos anexos, é o próximo ganho grande |
...
**110 feitos · 8 parciais · 10 planejados**, de 128 pedidos.

...
<!-- ROLLUP:inicio -->
*Gerado por `docs/pmo/rollup.py` em 16/09/2026 21:39 UTC — não conte à mão; o estado sai da última coluna de cada tabela abaixo, e o escalão da coluna `escalão`.*

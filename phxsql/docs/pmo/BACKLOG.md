...
<!-- ROLLUP:inicio -->
*Gerado por `docs/pmo/rollup.py` em 18/09/2026 03:08 UTC — não conte à mão; o estado sai da última coluna de cada tabela abaixo, e o escalão da coluna `escalão`.*

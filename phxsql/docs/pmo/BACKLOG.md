...
<!-- ROLLUP:inicio -->
*Gerado por `docs/pmo/rollup.py` em 23/09/2026 19:14 UTC — não conte à mão; o estado sai da última coluna de cada tabela abaixo, e o escalão da coluna `escalão`.*

...
| 143 das 170 guardas do catalogo | `docs/TESTES.md`, entre `<!-- guardas:inicio -->` e `<!-- guardas:fim -->` | sim | `bancada/guardas/tabela-no-testes.py`, corrida medida em 2026-09-16 15:25; o 170 e `len(GUARDAS)` medido em 17/09/2026 -- esta linha dizia 169 na noite de 16/09 e envelheceu em UMA entrada (`debug-da-ligacao-mostra-a-senha`, pedido 270) antes de o dia virar, e as 27 nao julgadas estao nomeadas na propria tabela desde o pedido 269. **A linha nao se digita e a LINHA do arquivo nao se cita**: ela anda a cada edicao, e citar `:720` foi o que deixou este numero parado em 77 por treze dias |

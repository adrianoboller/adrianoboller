...
| área | testes | % |
|---|---:|---:|
| Motor de dados (arquivos, índice, diários) | 274 | 24,6 |
| Protocolo e portões (despachar) | 162 | 14,6 |
| Núcleo (JSON, tipos, UUID, zip, paralelo) | 118 | 10,6 |
| Configuração | 76 | 6,8 |
| Criptografia e codificação | 75 | 6,7 |
| DbLink | 65 | 5,8 |
| Camada SQL (léxico, sintaxe, tradução) | 44 | 4,0 |
| Gatilhos e procedimentos | 38 | 3,4 |
| Jobs | 31 | 2,8 |
| Telemetria e profiler | 31 | 2,8 |
| Interface web (servidor HTTP) | 25 | 2,2 |
| MCP | 19 | 1,7 |
| Usuários e permissões | 19 | 1,7 |
| Console de terminal (phxsqlcmd) | 18 | 1,6 |
| Segurança de rede (blacklist, firewall) | 18 | 1,6 |
| ODBC | 17 | 1,5 |
| **Exportação** | **13** | **1,2** |
| **Mensagens (i18n do servidor)** | **13** | **1,2** |
| **Junções e união** | **13** | **1,2** |
| **Pivot** | **12** | **1,1** |
| **Replicação** | **11** | **1,0** |
...
| arquivo | linhas |
|---|---:|
| `phxsql-store/src/table.rs` | 2241 |

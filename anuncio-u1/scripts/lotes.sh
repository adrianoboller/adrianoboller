...
# (< 10 min), quadros impares 1..599 de 2 em 2 (15 fps efetivo) a 360x640 e
# 8 amostras -> saida/previa_seq/quadro_NNNN.png. Depois:
#   MODO=video bash scripts/previa.sh scripts/teste_coreografia.py
# junta tudo em saida/previa_20s.mp4.
#
# Custo medido: 16-41 s por quadro por software; 14 quadros por lote ficam
# abaixo dos 10 min. INI/FIM/TAM (quadros por lote) e CAIXA_SOME passam por
# variavel de ambiente; os logs vao para saida/previa_seq/logs/.
cd "$(dirname "$0")/.."

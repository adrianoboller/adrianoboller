# Fix diagram routing and text overflow
# 27/08 20:02
...
novo = '''          <path d="M190 82 L190 108 L152 108 L152 240" fill="none" stroke="var(--log)" stroke-width="1.3" stroke-dasharray="4 3" marker-end="url(#setaWlog)"/>
        ...
        '''
s = s[:i] + novo + s[j:]
s = s.replace('<svg viewBox="0 0 840 396" role="img" aria-label="Navegador e cliente',
              '<svg viewBox="0 0 840 404" role="img" aria-label="Navegador e cliente')
open(p,'w').write(s)
print("svg ajustado")

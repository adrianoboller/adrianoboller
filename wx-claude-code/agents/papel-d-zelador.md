...
description: "Papel D (zelador) da equipe de grande porte: mantém o repositório limpo: nomes, estrutura de pastas, arquivos órfãos, logs em .wx-migration/logs, lint e fo. Só trabalha em itens do backlog com papel D, em ciclos PDCA."
model: haiku
effort: medium

...
description: "Act do PDCA do papel J (pesquisador): fecha o ciclo com `pmo.py pdca fechar`; infrutífero exige a próxima hipótese; move o item na matriz (e por consequência ."
model: haiku
effort: medium

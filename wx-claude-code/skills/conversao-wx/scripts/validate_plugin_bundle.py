...
def validate(root: Path, strict: bool = False) -> dict:
    ...
    required = [
        ...
        "skills/conversao-wx/scripts/documentar_codigo.py",
        "skills/conversao-wx/scripts/pesar_tarefa.py",
        "skills/conversao-wx/scripts/i18n.py",
        "skills/conversao-wx/scripts/rag.py",
        ...
        "commands/pergunta.md",
        "commands/comandos.md",
        "commands/artefato.md",
        "skills/conversao-wx/scripts/listar_perguntas.py",
        ...
        "skills/conversao-wx/scripts/registro.py",
        "skills/conversao-wx/scripts/pdf_para_markdown.py",
        "commands/pdf.md",
        "commands/log.md",
        "skills/conversao-wx/scripts/arquivar_artefato.py",

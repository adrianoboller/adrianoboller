...
def medir() -> dict:
    ...
    return {
        ...
        "prints": conta("docs/prints/*.png"), "video_duracao": dur, "video_cenas": cenas, "video_php_duracao": dur_php, "video_php_cenas": cenas_php, "video_bateria_duracao": dur_bateria, "video_bateria_cenas": cenas_bateria, "video_primeiro_duracao": dur_primeiro, "video_primeiro_cenas": cenas_primeiro, "video_windev_duracao": dur_windev, "video_windev_cenas": cenas_windev, "destinos_provados": len(destinos), "golden_dos_destinos": " · ".join(f"{d['golden']} ({d['exemplo']})" for d in destinos), "destinos": destinos, "testes_wl_rt": testes_wl_rt,

...
def medir() -> dict:
    ...
    return {
        ...
        "prints": conta("docs/prints/*.png"), "video_duracao": dur, "video_cenas": cenas, "video_php_duracao": dur_php, "video_php_cenas": cenas_php, "video_bateria_duracao": dur_bateria, "video_bateria_cenas": cenas_bateria,

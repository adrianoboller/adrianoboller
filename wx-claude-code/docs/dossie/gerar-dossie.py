...
mapa = [("MANUAL.md, docs/manual-de-uso.pdf", "manual de oito capítulos"), ("docs/relatorio-do-plugin.md", "relatório medido do estado atual"), ("docs/investidor/", "página e PDF para investidores"), ("docs/prints/, docs/video/", "provas reais e o vídeo de uso"), ("docs/relatorio-de-cenarios.pdf", "relatório da bateria pesada, gerado rodando os doze cenários"), ("docs/analise-aula-vibe-coding.md", "o que a aula de vibe coding ensinou e o que não se copiou"), ("docs/telas-licenca/", "sete telas do fluxo de liberação de licença"), ("licenca/LEIA-ME.md", "o que o serial protege e o que não"), ("skills/LEIA-ME-erp.md", "as oito skills de ERP do pacote skills.sh e o esqueleto que L6 gera"), ("exemplos/estoque-wx/", "exemplo em WINDEV: teste de regressão do fluxo inteiro"), ("exemplos/faturamento-php/", "exemplo em PHP procedural, sem nada de WX; golden master capturado rodando o legado"), ("exemplos/clientes-php-mysql/", "o primeiro projeto de ponta a ponta: um CRUD PHP + MySQL → Rust + MySQL + React, com o destino provado dentro"), ("exemplos/estoque-wx/destino/", "o ESTOQUE convertido só dos PDFs: Rust + Axum + PostgreSQL 16 + React, golden e grafo conferidos pela bateria"), ("ferramentas/wl-rt/", "o runtime do WLanguage em Rust: moeda, data e strings com a semântica lida do Help"), ("ferramentas/wx-modelos/", "binário Rust, std pura, para escolher e controlar o modelo local"), ("ferramentas/wx-serial/", "emissor de serial e livro de emissões, fora do plugin: a chave privada não mora junto do produto"), ("docs/SEGURANCA.md", "o que a licença protege, o que não, e o esforço de cada ataque"), ("docs/workflow.pdf", "quem faz o quê e onde o trabalho espera gente"), ("docs/apresentacao.pdf", "roteiro de vinte minutos para apresentar a clientes"), ("docs/dossie/fluxo-atual.pdf", "o fluxograma, gerado do repositório desde a 3.34.0"), ("tests/testes.py", f"{n['testes']} testes; o validador estrito os roda")]

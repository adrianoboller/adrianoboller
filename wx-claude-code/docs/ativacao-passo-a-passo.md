...
1. Descompacte `wx-serial-3.47.0.zip` numa pasta que só você acessa. Ela
   nunca vai ao cliente: carrega o emissor de serial.
2. Gere o seu par de chaves:
...
3. Suba o receptor de avisos numa máquina sua, com o SMTP no ambiente:
...
4. Se o serial for preso a uma máquina, peça ao cliente o resultado de
...
6. O livro guarda cada emissão, fora do repositório:
...
7. Instalar e ativar no mesmo comando:
...
8. Se o plugin já estava instalado, só o serial:
...
9. Na instalação o plugin envia **um** aviso ao seu receptor: serial,
...
11. A partir daí toda sessão abre dizendo para quem o plugin está licenciado,
...
12. Cada instalação vira um e-mail do receptor:

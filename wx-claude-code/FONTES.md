# Fontes do WX Claude Code 3.32.0
...
| --- | ---: | ---: | --- |
| Comandos | 24 | 899 | um por recurso; `/wx-claude-code:<nome>` invoca cada um |
...
| Scripts | 31 | 14.644 | o que faz o trabalho: questionário, gates, PMO, licença, RAG, registro |
...
| Testes | 3 | 2.324 | a bateria; o validador estrito a roda |
...
| Documentos | 4 | 1.225 | manual, README, fontes e a instrução de ativação, na raiz |
...
Último commit no momento da medição: `fe45c79 2026-09-06`.

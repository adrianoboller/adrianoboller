# Fontes do WX Claude Code 3.39.0
...
| --- | ---: | ---: | --- |
| Comandos | 32 | 1.123 | um por recurso; `/wx-claude-code:<nome>` invoca cada um |
...
| Scripts | 39 | 16.737 | o que faz o trabalho: questionário, gates, PMO, licença, RAG, registro |
...
| Testes | 3 | 2.875 | a bateria; o validador estrito a roda |
...
Último commit no momento da medição: `0bdf799 2026-09-06`.

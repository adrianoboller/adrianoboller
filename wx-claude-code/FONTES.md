...
| --- | ---: | ---: | --- |
| Comandos | 23 | 867 | um por recurso; `/wx-claude-code:<nome>` invoca cada um |
...
| Scripts | 30 | 14.289 | o que faz o trabalho: questionário, gates, PMO, licença, RAG, registro |
...
| Testes | 3 | 2.201 | a bateria; o validador estrito a roda |
...
| Documentos | 4 | 1.192 | manual, README, fontes e a instrução de ativação, na raiz |

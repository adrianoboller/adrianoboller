# Fontes do WX Claude Code 3.27.0
...
| Testes | 1 | 1.273 | a bateria; o validador estrito a roda |
| Exemplo | 21 | 1.036 | projeto sintético que é o teste de regressão do fluxo inteiro |
| Documentos | 4 | 1.105 | manual, README, fontes e a instrução de ativação, na raiz |
| Documentos de apoio | 5 | 194 | relatório, análises, origens dos prints e o vídeo |
...
Último commit no momento da medição: `e3da283 2026-09-04`.

# Fontes do WX Claude Code 3.31.0
...
| --- | ---: | ---: | --- |
| Comandos | 23 | 859 | um por recurso; `/wx-claude-code:<nome>` invoca cada um |
...
| Scripts | 30 | 14.271 | o que faz o trabalho: questionário, gates, PMO, licença, RAG, registro |
...
| Testes | 3 | 2.181 | a bateria; o validador estrito a roda |
...
| Documentos | 4 | 1.181 | manual, README, fontes e a instrução de ativação, na raiz |
...
Último commit no momento da medição: `abcbedb 2026-09-05`.

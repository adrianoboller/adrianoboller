# Fontes do WX Claude Code 3.50.0

Inventário medido em 2026-09-09 por `docs/dossie/gerar-fontes.py`. Não se edita à mão: rode o script depois de acrescentar arquivo, e o teste `test_fontes_md_esta_em_dia` avisa quando ele envelhece.

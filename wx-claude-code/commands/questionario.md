...
| F | «sim» | depois de F0, faça as subperguntas uma por vez, na ordem F1 a F8 de `references/qualidade-erp.md` (quem opera; teclado e atalhos; grids; formulários; números, datas e moeda; impressão; estados e erros; acessibilidade), e só então preservar ou redesenhar → paleta → tema → tipografia → densidade → marca |

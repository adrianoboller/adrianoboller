...
2. Com os sinais, mostre **três opções com o porquê em uma frase cada**, sempre com estas três presentes e a recomendada primeiro:
   ...
   - **C# (.NET 8) + WL_C#**: a biblioteca WL_C# 1.2 porta 693 funções do WLanguage com o mesmo nome, o que torna a tradução das procedures quase mecânica; para a equipe WINDEV que vai manter o código.
